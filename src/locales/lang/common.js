const common = {
  ru: {
    ...
    built_by: "Создано на базе платформы Yasuké компании KalyChain",
  ...
  en: {
    ...
    built_by: "Yasuké Built by KalyChain dev team",
